...
export async function seedIfEmpty(): Promise<void> {
  ...
  const seed: Card[] = [
    ...
    },
    {
      id: nanoid(),
      type: 'event',
      name: 'Les Solidarités 2026 — Pass 3 jours',
      brandColor: '#EF4444',
      barcodeFormat: 'QR',
      barcodeValue: 'LES-SOLIDARITES-2026-PASS-A',
      eventDate: new Date(now + 1000 * 60 * 60 * 24 * 60).toISOString(),
      eventEndDate: new Date(now + 1000 * 60 * 60 * 24 * 62).toISOString(),
      venue: 'Citadelle de Namur, Belgique',
      organizer: 'Ticketmaster',
      tickets: [
        {
          id: nanoid(),
        ...
        },
        {
          id: nanoid(),
          barcodeFormat: 'QR',
          barcodeValue: 'LES-SOLIDARITES-2026-PASS-B',
          holderName: 'Marie',
          seat: 'Pass adulte',
        },
      ],
      notes: 'Bracelet à récupérer à l\'entrée Sud le vendredi.',
      createdAt: now,
      updatedAt: now,
      source: 'manual',
    },
